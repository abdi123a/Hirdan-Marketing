...
export default function TransferDetailScreen() {
  ...
  const openPreview = () => {
    ...
    router.push(`/(tabs)/more/transfer-preview/${transfer.id}`);
  };
        ...
        <View style={styles.actions}>
          {canAct ? (
            <>
              ...
              <Button title="Email link" variant="outline" onPress={openEmail} />
              <Button
              ...
              {canPreview ? (
                <Button
                  ...
                  variant="outline"
                  onPress={openPreview}
                  loading={previewNeedsHandoff && sharing}
                />
              ) : null}
            </>
          ) : null}
          ...
          {canRenew ? (
            <Button title="Renew link" variant="secondary" onPress={() => setRenewOpen(true)} />
          ) : null}

          <Button title="Access logs" variant="outline" onPress={() => setLogsOpen(true)} />

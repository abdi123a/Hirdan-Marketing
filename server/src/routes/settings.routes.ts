  ...
  try {
    ...
    res.json({
      settings: {
        ...
        recaptchaAndroidSiteKey: settings.recaptchaAndroidSiteKey,
        recaptchaIosSiteKey: settings.recaptchaIosSiteKey,
...
const settingsDtoSchema = z.object({
  ...
  recaptchaAndroidSiteKey: z.string().optional().nullable(),
  recaptchaIosSiteKey: z.string().optional().nullable(),
  recaptchaEnterpriseProjectId: z.string().optional().nullable(),

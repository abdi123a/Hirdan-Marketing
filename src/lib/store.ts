...
const createDefaultSettings = (): AgencySettings => ({
  ...
  logo: "https://placehold.co/200x60/5A428A/white?text=LOGO",
  whiteLogo: "https://placehold.co/200x60/white/5A428A?text=LOGO",
  favicon: "https://placehold.co/32x32/5A428A/white?text=H",
  signature: "",
  stamp: "",
  primaryColor: "#5A428A",
  taxRate: 15,

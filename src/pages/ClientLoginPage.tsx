...
import { User, ArrowRight, Mail, KeyRound } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative z-10">
        ...
        >
          <h1 className="text-5xl font-display font-bold text-white leading-tight mb-6">
            Client<br />
            <span className="text-gradient-gold">Portal Access</span>
          </h1>
          <p className="text-lg text-white/50 max-w-md leading-relaxed">
            View your invoices, proformas, and account details in one secure place. Use the access code provided by your account manager.
          </p>
          <div className="mt-12 space-y-4">
            {['View & download invoices', 'Track payment status', 'Access proforma documents', 'View account information'].map((feature) => (
        ...
        >
          <div className="bg-card rounded-3xl shadow-elevated border border-border/50 p-8 md:p-10">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-secondary to-secondary/80 mb-5 shadow-lg">
                <User className="w-8 h-8 text-white" />
              </div>
              <h2 className="text-2xl font-display font-bold text-foreground">Client Portal</h2>
              <p className="text-muted-foreground mt-2 text-sm">Sign in with your email and access code</p>
            </div>

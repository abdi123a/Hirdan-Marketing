        ...
        <div className="bg-card rounded-3xl border border-border/50 p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 rounded-xl bg-gradient-to-r from-secondary to-secondary/80 hover:from-secondary/90 hover:to-secondary/70 text-secondary-foreground font-semibold text-sm transition-all duration-300 shadow-none"
            >
              {isLoading ? (
                <motion.div

      ...
      <div className="space-y-6 max-w-5xl mx-auto">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-foreground tracking-tight">New Invoice</h1>
              <p className="text-muted-foreground mt-0.5">Create a professional invoice for your client</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <Card className="shadow-card border-border">
              ...
              <CardContent className="space-y-4">
                ...
                {form.clientEmail && (
                  <p className="text-sm text-muted-foreground -mt-2">📧 {form.clientEmail}</p>
                )}
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input id="discount" type="number" min="0" placeholder="0" value={form.discount || 0} onChange={(e) => setField("discount", parseFloat(e.target.value) || 0)} />
                  </div>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <Input id="deposit" type="number" min="0" placeholder="0" value={form.deposit || 0} onChange={(e) => setField("deposit", parseFloat(e.target.value) || 0)} />
                  </div>
                  {form.status === "Paid" ? (
                    <div className="space-y-1.5">
            ...
            <Card className="shadow-card border-border">
              ...
              <CardContent className="space-y-3">
                ...
                <div className="grid grid-cols-12 gap-2 text-xs font-semibold text-muted-foreground uppercase tracking-wide px-1">
                  ...
                  <span className="col-span-1 text-center" title="Apply the invoice discount to this item">Disc.</span>
                  ...
                  >
                    ...
                    <div className="col-span-1 flex justify-center pt-3">
                      <input
                        ...
                        title="Apply the invoice discount to this item"
                      />
                    </div>

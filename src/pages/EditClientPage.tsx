...
export default function EditClientPage() {
  ...
  const { clients, updateClient, fetchClients } = useAgencyStore();
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-foreground tracking-tight">Edit Client</h1>
          <p className="text-muted-foreground mt-0.5">Update the details for {form.company || form.name}</p>
        </div>
      </div>
